...
# Bot Information
API_ID = int(environ.get("API_ID", "26804817"))
API_HASH = environ.get("API_HASH", "ff90ff6dfd81d59cfad4cae4b67d538e")
BOT_TOKEN = environ.get("BOT_TOKEN", "")

PICS = (environ.get('PICS', 'https://graph.org/file/ce1723991756e48c35aa1.jpg')).split() # Bot Start Picture
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1417368612').split()]
BOT_USERNAME = environ.get("BOT_USERNAME", "thefsrobot") # without @
